...
exports.verifySessionId = function verifySessionId(encryptedSessionId, clientData, sessionId) {
    return clientData.secrets.reduce((isValid, secret) => isValid || verifyString(encryptedSessionId, sessionId, secret), false);
};
