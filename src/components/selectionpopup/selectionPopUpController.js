...
exports.getProducts = async function getProducts(req, res, next, service = _service) {
    ...
    try {
        const validatorResult = await service.prepareProductSelectionData(deviceClass, devicePrice, req.clientConfig, req.locale.language, orderItemId, req.shoppingCart);
