...
const componentTextsController = require('../adminUI/client/componentTextsController');
...
router.post("/:clientId/component-texts", componentTextsController.saveComponentTexts);
