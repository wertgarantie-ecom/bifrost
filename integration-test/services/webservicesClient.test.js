...
describe("webservices roundtrip", () => {
    ...
    test("should execute proper login call", async (done) => {
    ...
    test("should get agent data", async (done) => {
        ...
        const requestParameters = {
            session: "DG21585917903JR99E8D45931QQ81J1TL3CX4Q49181L17Q921Z233GB6ER5XI"
        };

        const agentData = await webservicesClient.getAgentData(requestParameters);
