...
test("should return valid confirmation data", async () => {
    ...
    expect(response.body.confirmations.confirmationTextTermsAndConditions).toEqual("Ich akzeptiere die Allgemeinen Versicherungsbedingungen <a target=\"_blank\" href=\"http://localhost:3000/wertgarantie/documents/9448f030d5684ed3d587aa4e6167a1fd918aa47b\">(AVB)</a> und die Bestimmungen zum <a target=\"_blank\" href=\"http://localhost:3000/wertgarantie/documents/e2289cb6c7e945f4e79bab6b250cb0be34a9960e\">Datenschutz</a>. Das gesetzliche <a target=\"_blank\" href=\"http://localhost:3000/wertgarantie/documents/6a9715485af877495e38b24b093d603436c433eb\">Widerrufsrecht</a> und das Produktinformationsblatt <a target=\"_blank\" href=\"http://localhost:3000/wertgarantie/documents/8835ff3c803f3e7abc5d49527001678bb179cfaa\">(IPID)</a> habe ich zur Kenntnis genommen und alle Dokumente heruntergeladen. Mit der Bestätigung der Checkbox erkläre ich mich damit einverstanden, dass mir alle vorstehenden Unterlagen an meine E-Mail-Adresse übermittelt werden. Der Übertragung der erforderlichen Daten zur Übermittlung meines Versicherungsantrages an die WERTGARANTIE AG per E-Mail stimme ich zu. Der Betrag wird separat per Rechnung bezahlt.");
