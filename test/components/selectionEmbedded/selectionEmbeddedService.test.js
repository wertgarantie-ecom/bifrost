...
test("should prepare correct product offers", async () => {
    const result = await selectionEmbeddedService.prepareProductSelectionData("Smartphone", 90000, clientData, "de", mockProductOfferService, productImagesServiceMock, mockComponentTextsService);
